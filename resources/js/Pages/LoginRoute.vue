<template>
    <div class="flex w-full items-center justify-center magicpattern ">
        ...
        <div class="flex w-[400px] md:w-[800px] h-[500px] justify-center items-center rounded-lg overflow-hidden  bg-base-100  animate-fade-up animate-ease-in">
            <div class="hidden md:block md:w-1/2 h-full relative overflow-hidden">
                <img src="/resources/media/background.png" alt="" class="h-full w-full    object-cover ">
                ...
                <div class="flex flex-col h-full justify-center p-8 ">
                    ...
                    <fieldset class="fieldset w-xs mt-4">
                        ...
                        <label class="input validator">
                            ...
                            <input type="email" placeholder="exemplo@dominio.com" required/>
                        </label>
                        ...
                        <button class="btn rounded-lg btn-neutral mt-4">Login</button>
                    </fieldset>
                </div>
            </div>
        </div>
